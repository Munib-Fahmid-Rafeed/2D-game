...
def draw_rectangle(x, y, width, height, color):
    ...
    # Draw the top line using the midpoint line algorithm
    draw_midpoint_line(x, y, x + width, y)

    # Draw the right line using the midpoint line algorithm
    draw_midpoint_line(x + width, y, x + width, y + height)

    # Draw the bottom line using the midpoint line algorithm
    draw_midpoint_line(x + width, y + height, x, y + height)

    # Draw the left line using the midpoint line algorithm
    draw_midpoint_line(x, y + height, x, y)

    # Draw rounded edges using the midpoint circle algorithm
    draw_midpoint_circle(x, y + height / 2, height / 2)
    draw_midpoint_circle(x + width, y + height / 2, height / 2)
